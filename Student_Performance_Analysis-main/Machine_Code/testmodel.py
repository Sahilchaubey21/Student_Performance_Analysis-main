...
model = tf.keras.models.load_model(r'C:\Users\sahil\OneDrive\Desktop\Student_Performance_Analysis-main\Student_Performance_Analysis-main\model\student_performance_model.h5')
